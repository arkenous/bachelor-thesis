...
\chapter{実験と考察}
    ...
    \section{考察} % 被験者別に見るものと，モーション別に見るもの，2つの視点で書く．文章を練り直す
...
\chapter{おわりに} % 文章を練り直す
%本研究では，新規登録や個人認証の精度を高めるためにモーションの振れ幅を増幅する機能やフーリエ変換を用いたローパスフィルタ，モーション取得時のズレを行う機能を実装することにより，新規登録や個人認証時の精度を向上することができた．
